        ...
        <div class="nk-content-body">
            <div class="nk-block-head">
                ...
                <div class="nk-block-between-md g-4">
                    ...
                    <div class="nk-block-head-sub"><a class="back-to" href="assigned-job-order.php"><em class="icon ni ni-arrow-left"></em><span>Back</span></a></div>
                        <h2 class="nk-block-title fw-normal customtitleBTMargin titlemargin_0">Job Order Details</h2>
